...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Settings&&const DeepCollectionEquality().equals(other.prayerTimes, prayerTimes)&&const DeepCollectionEquality().equals(other.offsets, offsets)&&(identical(other.notificationsEnabled, notificationsEnabled) || other.notificationsEnabled == notificationsEnabled)&&(identical(other.hapticsEnabled, hapticsEnabled) || other.hapticsEnabled == hapticsEnabled)&&(identical(other.pointsVisible, pointsVisible) || other.pointsVisible == pointsVisible)&&(identical(other.themeMode, themeMode) || other.themeMode == themeMode)&&(identical(other.localeCode, localeCode) || other.localeCode == localeCode)&&(identical(other.weekStart, weekStart) || other.weekStart == weekStart)&&(identical(other.onboardingComplete, onboardingComplete) || other.onboardingComplete == onboardingComplete)&&(identical(other.appLockEnabled, appLockEnabled) || other.appLockEnabled == appLockEnabled));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(prayerTimes),const DeepCollectionEquality().hash(offsets),notificationsEnabled,hapticsEnabled,pointsVisible,themeMode,localeCode,weekStart,onboardingComplete,appLockEnabled);

@override
String toString() {
  return 'Settings(prayerTimes: $prayerTimes, offsets: $offsets, notificationsEnabled: $notificationsEnabled, hapticsEnabled: $hapticsEnabled, pointsVisible: $pointsVisible, themeMode: $themeMode, localeCode: $localeCode, weekStart: $weekStart, onboardingComplete: $onboardingComplete, appLockEnabled: $appLockEnabled)';
}
...
/// Create a copy of Settings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? prayerTimes = null,Object? offsets = null,Object? notificationsEnabled = null,Object? hapticsEnabled = null,Object? pointsVisible = null,Object? themeMode = null,Object? localeCode = freezed,Object? weekStart = null,Object? onboardingComplete = null,Object? appLockEnabled = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  Map<PrayerType, TimeOfDay> prayerTimes, @HiveField(1)  Map<PrayerType, int> offsets, @HiveField(2)  bool notificationsEnabled, @HiveField(3)  bool hapticsEnabled, @HiveField(4)  bool pointsVisible, @HiveField(5)  AppThemeMode themeMode, @HiveField(6)  String? localeCode, @HiveField(7)  int weekStart, @HiveField(8)  bool onboardingComplete, @HiveField(9)  bool appLockEnabled)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Settings() when $default != null:
return $default(_that.prayerTimes,_that.offsets,_that.notificationsEnabled,_that.hapticsEnabled,_that.pointsVisible,_that.themeMode,_that.localeCode,_that.weekStart,_that.onboardingComplete,_that.appLockEnabled);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  Map<PrayerType, TimeOfDay> prayerTimes, @HiveField(1)  Map<PrayerType, int> offsets, @HiveField(2)  bool notificationsEnabled, @HiveField(3)  bool hapticsEnabled, @HiveField(4)  bool pointsVisible, @HiveField(5)  AppThemeMode themeMode, @HiveField(6)  String? localeCode, @HiveField(7)  int weekStart, @HiveField(8)  bool onboardingComplete, @HiveField(9)  bool appLockEnabled)  $default,) {final _that = this;
switch (_that) {
case _Settings():
return $default(_that.prayerTimes,_that.offsets,_that.notificationsEnabled,_that.hapticsEnabled,_that.pointsVisible,_that.themeMode,_that.localeCode,_that.weekStart,_that.onboardingComplete,_that.appLockEnabled);case _:
  throw StateError('Unexpected subclass');
...
@override@HiveField(4) final  bool pointsVisible;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_prayerTimes),const DeepCollectionEquality().hash(_offsets),notificationsEnabled,hapticsEnabled,pointsVisible,themeMode,localeCode,weekStart,onboardingComplete,appLockEnabled);
...
/// Create a copy of Settings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? prayerTimes = null,Object? offsets = null,Object? notificationsEnabled = null,Object? hapticsEnabled = null,Object? pointsVisible = null,Object? themeMode = null,Object? localeCode = freezed,Object? weekStart = null,Object? onboardingComplete = null,Object? appLockEnabled = null,}) {
