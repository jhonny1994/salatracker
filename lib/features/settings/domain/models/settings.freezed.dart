...
@HiveField(0) Map<PrayerType, TimeOfDay> get prayerTimes;@HiveField(1) Map<PrayerType, int> get offsets;@HiveField(2) bool get notificationsEnabled;@HiveField(3) bool get hapticsEnabled;@HiveField(5) AppThemeMode get themeMode;@HiveField(6) String? get localeCode;@HiveField(7) int get weekStart;@HiveField(8) bool get onboardingComplete;@HiveField(9) bool get appLockEnabled;@HiveField(10) bool get biometricUnlockEnabled;@HiveField(11) List<DailyReminderConfig>? get dailyReminders;
...
@useResult
$Res call({
@HiveField(0) Map<PrayerType, TimeOfDay> prayerTimes,@HiveField(1) Map<PrayerType, int> offsets,@HiveField(2) bool notificationsEnabled,@HiveField(3) bool hapticsEnabled,@HiveField(5) AppThemeMode themeMode,@HiveField(6) String? localeCode,@HiveField(7) int weekStart,@HiveField(8) bool onboardingComplete,@HiveField(9) bool appLockEnabled,@HiveField(10) bool biometricUnlockEnabled,@HiveField(11) List<DailyReminderConfig>? dailyReminders
});
...
as bool,dailyReminders: freezed == dailyReminders ? _self.dailyReminders : dailyReminders // ignore: cast_nullable_to_non_nullable
as List<DailyReminderConfig>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@HiveField(0)  Map<PrayerType, TimeOfDay> prayerTimes, @HiveField(1)  Map<PrayerType, int> offsets, @HiveField(2)  bool notificationsEnabled, @HiveField(3)  bool hapticsEnabled, @HiveField(5)  AppThemeMode themeMode, @HiveField(6)  String? localeCode, @HiveField(7)  int weekStart, @HiveField(8)  bool onboardingComplete, @HiveField(9)  bool appLockEnabled, @HiveField(10)  bool biometricUnlockEnabled, @HiveField(11)  List<DailyReminderConfig>? dailyReminders)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Settings() when $default != null:
return $default(_that.prayerTimes,_that.offsets,_that.notificationsEnabled,_that.hapticsEnabled,_that.themeMode,_that.localeCode,_that.weekStart,_that.onboardingComplete,_that.appLockEnabled,_that.biometricUnlockEnabled,_that.dailyReminders);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@HiveField(0)  Map<PrayerType, TimeOfDay> prayerTimes, @HiveField(1)  Map<PrayerType, int> offsets, @HiveField(2)  bool notificationsEnabled, @HiveField(3)  bool hapticsEnabled, @HiveField(5)  AppThemeMode themeMode, @HiveField(6)  String? localeCode, @HiveField(7)  int weekStart, @HiveField(8)  bool onboardingComplete, @HiveField(9)  bool appLockEnabled, @HiveField(10)  bool biometricUnlockEnabled, @HiveField(11)  List<DailyReminderConfig>? dailyReminders)  $default,) {final _that = this;
switch (_that) {
case _Settings():
return $default(_that.prayerTimes,_that.offsets,_that.notificationsEnabled,_that.hapticsEnabled,_that.themeMode,_that.localeCode,_that.weekStart,_that.onboardingComplete,_that.appLockEnabled,_that.biometricUnlockEnabled,_that.dailyReminders);case _:
  throw StateError('Unexpected subclass');
...
@override@HiveField(10) final  bool biometricUnlockEnabled;
 final  List<DailyReminderConfig>? _dailyReminders;
@override@HiveField(11) List<DailyReminderConfig>? get dailyReminders {
  final value = _dailyReminders;
  if (value == null) return null;
  if (_dailyReminders is EqualUnmodifiableListView) return _dailyReminders;
  // ignore: implicit_dynamic_type
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Settings&&const DeepCollectionEquality().equals(other._prayerTimes, _prayerTimes)&&const DeepCollectionEquality().equals(other._offsets, _offsets)&&(identical(other.notificationsEnabled, notificationsEnabled) || other.notificationsEnabled == notificationsEnabled)&&(identical(other.hapticsEnabled, hapticsEnabled) || other.hapticsEnabled == hapticsEnabled)&&(identical(other.themeMode, themeMode) || other.themeMode == themeMode)&&(identical(other.localeCode, localeCode) || other.localeCode == localeCode)&&(identical(other.weekStart, weekStart) || other.weekStart == weekStart)&&(identical(other.onboardingComplete, onboardingComplete) || other.onboardingComplete == onboardingComplete)&&(identical(other.appLockEnabled, appLockEnabled) || other.appLockEnabled == appLockEnabled)&&(identical(other.biometricUnlockEnabled, biometricUnlockEnabled) || other.biometricUnlockEnabled == biometricUnlockEnabled)&&const DeepCollectionEquality().equals(other._dailyReminders, _dailyReminders));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_prayerTimes),const DeepCollectionEquality().hash(_offsets),notificationsEnabled,hapticsEnabled,themeMode,localeCode,weekStart,onboardingComplete,appLockEnabled,biometricUnlockEnabled,const DeepCollectionEquality().hash(_dailyReminders));
...
as bool,appLockEnabled: null == appLockEnabled ? _self.appLockEnabled : appLockEnabled // ignore: cast_nullable_to_non_nullable
as bool,biometricUnlockEnabled: null == biometricUnlockEnabled ? _self.biometricUnlockEnabled : biometricUnlockEnabled // ignore: cast_nullable_to_non_nullable
as bool,dailyReminders: freezed == dailyReminders ? _self._dailyReminders : dailyReminders // ignore: cast_nullable_to_non_nullable
as List<DailyReminderConfig>?,
  ));
}
