...
- In-app update support (Settings-only):
  ...
  - Minimum-supported version policy with grace window before hard block
...
- App update controls and status in Settings
...
- Play and sideload artifacts are flavor-separated for update policy compliance
