...
- UX/gamification/psychology alignment per docs/ux-gamification-psychology.md
...
## Data Model
- PrayerDay: date, entries[], isComplete, points
- PrayerEntry: type, scheduledTime, checkedAt, isCompleted
- Settings: times, offsets, theme, language, app lock prefs
